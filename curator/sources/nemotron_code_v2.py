...
class NemotronCodeV2Source(_StreamingHFJsonlSource):
    SOURCE_TAG = "nemotron_code_v2"
    SHARD_PREFIX = "nemotron_code_v2"
    DATASET_NAME = "nvidia/Nemotron-Pretraining-Code-v2"
    CONFIG_NAME = None
    SPLIT = "train"
