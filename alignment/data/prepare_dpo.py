...
def prepare_handcrafted_behavior_dpo() -> list[dict]:
    ...
    examples.extend([
        ...
        },
        {
            ...
            "user": "What is 2 + 2?",
            "chosen": "4",
            "rejected": "2 + 2 is a math question about the number 2.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "Answer only the result: 2 + 2",
            "chosen": "4",
            "rejected": "2 + 2",
        },
        {
            ...
            "user": "What is two plus two?",
            "chosen": "4",
            "rejected": "Two plus two means two is equal to itself.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "What is 3 + 4?",
            "chosen": "7",
            "rejected": "3 + 4 is an expression using the numbers 3 and 4.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "What is 8 + 1?",
            "chosen": "9",
            "rejected": "8 + 1 means 8 is next to 1.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "What is 6 - 2?",
            "chosen": "4",
            "rejected": "6 - 2 is a subtraction expression.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "What is 4 * 2?",
            "chosen": "8",
            "rejected": "4 * 2 equals 6 because you combine four and two.",
        },
        {
            "dpo_type": "ai_concept",
            ...
            "rejected": "A transformer is also known as a Recurrent Neural Network that processes tokens one at a time.",
        },
        {
            "dpo_type": "ai_concept",
            "user": "In AI, what is a transformer model?",
            "chosen": "A transformer is a neural network architecture based on attention, commonly used for language and sequence modeling.",
            "rejected": "A transformer is a recurrent neural network, or RNN, that mainly relies on recurrence.",
        },
        {
            "dpo_type": "ai_concept",
            "user": "Is a transformer the same as an RNN?",
            "chosen": "No. A transformer uses attention mechanisms, while an RNN processes sequences recurrently.",
            "rejected": "Yes. A transformer is simply another name for a recurrent neural network.",
        },
        {
            "dpo_type": "ai_concept",
            "user": "What mechanism is central to transformer models?",
            "chosen": "Attention is central to transformer models.",
            "rejected": "Recurrence is the central mechanism in transformer models.",
        },
        {
            "dpo_type": "arithmetic",
            "user": "What is 7 - 3?",
